...
open class ENSideMenu : NSObject, UIGestureRecognizerDelegate {
    ...
    public init(sourceView: UIView, menuPosition: ENSideMenuPosition, blurStyle: UIBlurEffect.Style = .light) {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(ENSideMenu.deviceOrientationChanged(_:)), name: UIDevice.orientationDidChangeNotification, object: nil)
